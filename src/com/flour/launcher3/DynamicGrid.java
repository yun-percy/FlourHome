...
public class DynamicGrid {
    ...
    public DynamicGrid(Context context, Resources resources,
		...
		deviceProfiles.add(new DeviceProfile("Flour 720P",
			    359, 518,  5, 4,  60, 13, (hasAA ? 5 : 4), 60));
		deviceProfiles.add(new DeviceProfile("Flour 480P",
				296, 491.33f,  4, 4,  48, 13, (hasAA ? 5 : 4), 48));
        // The tablet profie is odd in that the landscape orientation
