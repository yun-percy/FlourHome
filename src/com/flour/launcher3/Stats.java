...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "com.flour.launcher3.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.flour.launcher3.permission.RECEIVE_LAUNCH_BROADCASTS";
